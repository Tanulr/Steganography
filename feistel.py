...
k1 = key_gen(length, length)
k2 = key_gen(length/2, length)
...
def feistel_encrypt(data_string, k1, k2):
    #getting converted ascii list of data string
...
def feistel_decrypt(cipher_text, k1, k2):
    ...
    print("Original text: ", ans_text)
    return ans_text

a = feistel_encrypt(text, k1, k2)
b = feistel_decrypt(a, k1, k2)
